...
export const Actions3 = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/php-react/ORDER-R.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const deleteUser3 = (theID) => {
    ...
    fetch("http://localhost/php-react/ORDER-D.php", {
      method: "POST",
      headers: {
  ...
  const updateUser3 = (userData) => {
    fetch("http://localhost/php-react/ORDER-U.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const insertUser3 = (newUser) => {
    fetch("http://localhost/php-react/ORDER-C.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
