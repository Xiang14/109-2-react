...
export const Actions5 = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/php-react/DETAIL-R.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const deleteUser5 = (theID) => {
    ...
    fetch("http://localhost/php-react/DETAIL-D.php", {
      method: "POST",
      headers: {
  ...
  const updateUser5 = (userData) => {
    fetch("http://localhost/php-react/DETAIL-U.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const insertUser5 = (newUser) => {
    fetch("http://localhost/php-react/DETAIL-C.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
