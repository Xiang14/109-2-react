...
export const Actions2 = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/php-react/PROD-R.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const insertUser2 = (newUser) => {
    fetch("http://localhost/php-react/PROD-C.php", {
      method: "POST",
      headers: {
  ...
  const deleteUser2 = (theID) => {
    ...
    fetch("http://localhost/php-react/PROD-D.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const updateUser2 = (userData) => {
    fetch("http://localhost/php-react/PROD-U.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
