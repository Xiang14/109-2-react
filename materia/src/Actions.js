...
export const Actions = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/php-react/EMP-R.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const insertUser = (newUser) => {
    fetch("http://localhost/php-react/EMP-C.php", {
      method: "POST",
      headers: {
  ...
  const updateUser = (userData) => {
    fetch("http://localhost/php-react/EMP-U.php.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteUser = (theID) => {
    ...
    fetch("http://localhost/php-react/dEMP-D.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
